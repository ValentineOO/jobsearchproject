...
import yinyangg from "../Assets/yinyangg.png";
...
const Value = () => {
  return (
    <div className="mb-[4rem] mt-[6rem]">
        ...
        <div className="singleGrid rounded-[10px] hover:bg-[#eeedf7] p-[1.5rem]">
          <div className="flex items-center gap-3">
            <div className="imgDiv p-[4px] rounded-[.8rem] bg-[#dedef8] h-[40px] w-[40px] flex items-center justify-center">
              <img src={yinyangg} alt="" className="w-[70%]" />
            </div>
          ...
          <p className="text-[13px] text-textColor opacity-[.7] py-[1rem] font-semibold">
            Things being made beautiful and simple are at the heart of what we
            do!
          </p>
        </div>
      ...
      <div className="cardd mt-[2rem] flex justify-between bg-greyIsh p-[5rem] rounded-[10px] ">
        <div>
